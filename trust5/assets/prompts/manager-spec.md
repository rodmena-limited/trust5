...
1. Check project documentation: Check whether `Use the InitProject tool` is running and is up to date.
...
[HARD] You MUST create these files using the `Write` tool. Do not just describe them.
