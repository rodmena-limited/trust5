...
- IMPLEMENT phase: For new features (HYBRID mode), implement requirements from SPEC using TDD/DDD.
...
- New feature implementation (HYBRID mode) - MUST use Write tool to create source files.
